...
export const Register = () => {
  ...
  const toggleShownPassword = ({ currentTarget: button }) => {
    ...
    <>
      <div theme={theme} className="login-register-page">
        <div className="login-register-box">
          <h1 className="login-register-title">ثبت نام</h1>
          ...
          <label
            ...
            className="login-register-input-label"
          >
            <div className="login-register-icon-box">
              <Lock sx={iconStyle} />
              <button
              ...
              >
                <VisibilitySharp
                  sx={{
                    ...iconStyle,
                    display: isConfirmPasswordShown ? "block" : "none",
                  }}
                />
                <VisibilityOffSharp
                  sx={{
                    ...iconStyle,
                    display: isConfirmPasswordShown ? "none" : "block",
                  }}
                />
              </button>
            </div>
